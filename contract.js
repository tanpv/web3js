...
let address = "0xd26114cd6EE289AccF82350c8d8487fedB8A0C07";
let contract = new web3.eth.Contract(abi, address);

// console.log(contract);
// read the name
contract.methods.name().call((error, result) => {console.log(result)});
contract.methods.symbol().call((error, result) => {console.log(result)});
contract.methods.totalSupply().call((error, result) => {console.log(result)});
contract.methods.balanceOf("0xdad0504abe6e09b777e3b3904e632e7ef6a8931c").call((error, result) => {console.log(result)});
